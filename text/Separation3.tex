...
Omeni, da je optimalen cikel najden skoraj instantno (znotraj 5 odstotkov prvih korenov).
...
Poiskati LCA(p,q) za najden optimalen cikel(p,r,q) za koren r. Če LCA = z != r, potem lahko skrajšamo cikel na (p,z,q). V naših testih se ne pozna razlika, ker so točke enakomerno razporejene in je optimalen cikel hitro najden.

Hitrost najdbe najkrajšega cikla je odvisna od njegove dolžine.
