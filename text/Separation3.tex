...
\begin{figure}
\centerline{\includegraphics[scale=0.8]{vd-sredisce.jpg}}
...
\begin{figure}
\centerline{\includegraphics[scale=0.5]{qp_path_proof.png}}
\caption{aa}
\label{c1c2}
\end{figure}
...
\begin{figure}
\centerline{\includegraphics[scale=0.3]{w_points5000-1.png}}
