...
protected: // some internal stuffs
  ...
  //std::unordered_map < const Point_2<CGAL::Cartesian <double>>*, Face_handle> pointsToFaceHandlers;
public:
...
public:
	...
	//Face_handle getFaceFromPoint(const Point_2<CGAL::Cartesian<double> >* p) {
	//	//std::cout << "map size: " << pointsToFaceHandlers.size() << std::endl;
