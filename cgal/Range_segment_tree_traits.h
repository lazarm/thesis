...
template<class Key_1>
  ...
  public:
    ...
    {
	  //return SMALLER == compare_x(k1,k2);//lazar
      return SMALLER == compare_x(k1.point,k2.point);
    }
  };
...
template<class Key_2>
  ...
  public:
    ...
    {
      //return SMALLER == compare_y(k1,k2);//lazar
	  return SMALLER == compare_y(k1.point,k2.point);
    }
  };
