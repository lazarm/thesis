...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Two Optimization Problems for Unit Disks\thanks{Supported by the Slovenian Research Agency, core program P1-0297 and project L7-5459.}}

\author{Sergio Cabello\footnote{FMF, University of Ljubljana, and 
	Institute of Mathematics, Physics and Mechanics, Slovenia.}
\and
	Lazar Milinkovi\'c\footnote{FMF and FRI, University of Ljubljana, Slovenia.}}
...
For this we take the rectangle of size $32\times 8$ with one small hole,
the original 2K points, and add 500 extra points on a vertical strip of width $1$ within the domain
and symmetric with respect to segment $st$. The generic algorithm took 435 seconds and the new
algorithm took 94 seconds. If instead we add 1K points, the generic algorithm takes more than 15 minutes and the new algorithm takes 173 seconds.
...
generic algorithm			&	730	&	215	&	67	&	30 \\
...
size rectangle	&	$32\times 8$ &	$64\times 16$ & $128\times 32$ & $32\times 8$ &	$64\times 16$ & $128\times 32$\\	
\hline
new separation algorithm	&	20	&	25	&	5.6	&	233 & 259 & 240  \\
generic algorithm			&	62	&	25	&	6.4	&	875 & 428 & 248 \\
cycle length				&	24  &   61	&	201 &	29	& 77  & 342 
\end{tabular}
