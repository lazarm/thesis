...
and symmetric with respect to segment $st$. The generic algorithm took 94 seconds and the new
algorithm took 435 seconds. If instead we add 1K points, the generic algorithm takes more than 15 minutes and the new algorithm takes 173 seconds.
